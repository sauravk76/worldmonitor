...
- **Score boost**: Do-Not-Travel → +15 points, Reconsider → +10, Caution → +5
- **Score floor**: Do-Not-Travel forces a minimum CII score of 60; Reconsider forces minimum 50. This prevents a country with low event data but active high-severity advisory input from showing an artificially calm score
